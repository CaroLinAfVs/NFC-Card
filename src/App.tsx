  ...
  return (
    <div className="bg-[#0d192b] h-screen flex justify-center items-center">
      <div className="bg-[#14253d] p-6	max-w-xs  h-[580px] rounded-xl shadow-3xl">
        <Image src="./equilibrium.jpeg" alt="main"/>
        
        <div className=" pt-7 ">
          <a
            className="text-2xl py-2 text-white font-bold focus:border-2 focus:border-dashed focus:border-[#00fff7] focus:outline-none hover:text-[#00fff7]"
            href="#"
          >
            Equilibrium #3429
          </a>
          ...
          <div className="PRICE py-3 border-b border-b-slate-600 flex justify-between	">
          ...
          <div className="AVATAR flex items-center py-3">
            <img
            ...
            <p className="text-lg text-[#8bacda]">
              Creation of
              <a
                className="py-2 text-white ml-2 font-bold focus:border-2 focus:border-dashed focus:border-[#00fff7] focus:outline-none hover:text-[#00fff7]"
                href="#"
              >
                Jules Wyvern
              </a>
